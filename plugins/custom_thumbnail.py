...
@Botly.on_message(filters.private & filters.photo)
async def save_photo(bot, update):
    await AddUser(bot, update)
    await botly.set_thumbnail(update.from_user.id, thumbnail=update.photo.file_id)
...
@Botly.on_message(filters.private & filters.command("delthumbnail"))
async def delthumbnail(bot, update):
    await AddUser(bot, update)
    await botly.set_thumbnail(update.from_user.id, thumbnail=None)
...
@Botly.on_message(filters.private & filters.command("viewthumbnail") )
async def viewthumbnail(bot, update):
    await AddUser(bot, update)
    thumbnail = await botly.get_thumbnail(update.from_user.id)
...
async def Gthumb01(bot, update):
    ...
    db_thumbnail = await botly.get_thumbnail(update.from_user.id)
